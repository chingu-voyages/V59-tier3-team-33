    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lodgings', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            model_name='lodging',
            constraint=models.UniqueConstraint(fields=('name', 'trip'), name='unique_lodging_per_trip'),
        ),
        migrations.AddConstraint(
            model_name='lodging',
